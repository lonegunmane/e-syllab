    ...
    <div className="fixed inset-0 bg-slate-950/80 backdrop-blur-md z-50 flex items-center justify-center p-4">
      <div className="glass-card shadow-2xl max-w-md w-full p-8 text-center animate-in fade-in zoom-in-95">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            disabled={loading}
            className="w-full py-3 bg-primary-600 text-white font-bold rounded-xl flex items-center justify-center gap-2 hover:bg-primary-700 transition-all shadow-lg shadow-primary-900/40 disabled:opacity-70 active:scale-95 cursor-pointer"
          >
            {loading ? (
              <>
        ...
        <button
          onClick={onLogout}
          className="mt-6 text-[10px] uppercase tracking-widest text-slate-500 hover:text-primary-400 hover:underline flex items-center justify-center gap-2 mx-auto font-bold transition-colors cursor-pointer"
        >
